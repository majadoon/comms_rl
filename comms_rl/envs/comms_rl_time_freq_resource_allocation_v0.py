...
class CommsRLTimeFreqResourceAllocationV0(Env):
    metadata = {
    ...
    def __init__(self, n_ues=32, n_prbs=25, buffer_max_size=32, eirp_dbm=13, f_carrier_mhz=2655,
        ...
        self.t_max = t_max
        self.tti_max = ceil(t_max/n_prbs)    # transmission time interval
        ...
        self.qi = None   # QoS identifier
        self.p = 0      # current prb index being allocated
